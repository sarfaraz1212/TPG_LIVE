...
<body style="background-color: #f8f9fa; font-family: Arial, sans-serif;">
    ...
    <div style="margin-top: 50px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); background-color: #fff;" align="center">
        ...
        <div style="padding: 20px;">
            ...
            <a href="{{ route('view.client-reset-password',['token' => $token]) }}" style="display: block; border-color: #007bff; color: black; text-decoration: none; padding: 12px 20px; font-size: 18px; font-weight: bold; letter-spacing: 1px; text-align: center; margin-bottom: 20px; transition: background-color 0.3s ease;">Reset Password</a>
