  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="box">
            <form action="{{ route('edit.diet',['id'=>$diet_id]) }}" method="POST">
                @csrf
                ...
                @endphp
                    @foreach($diet->meals as $index => $meal)
                        @php
                            $proteins = isset($diet->protein[$index]) ? $diet->protein[$index] : '';
                            $carbs = isset($diet->carbs[$index])? $diet->carbs[$index] : '';
                            $fats = isset($diet->fats[$index])? $diet->fats[$index] : '';
                            $calories = isset($diet->calories[$index])? $diet->calories[$index] : '';
                            $i++;
                        @endphp
                        <div class="row mt-4 meal-row">
                            <div class="col-5">
                                <label for="" class="meal-label" >Meal {{$i}}</label>
                                <input class="form-control" type="text" name="meal[]" value="{{$meal}}" >
                            </div>

                            <div class="col-1">
                                <label for="">Protien</label>
                                <input class="form-control" type="text" name="protein[]" id="" value="{{$proteins}}">
                            </div>

                            
                            <div class="col-1">
                                <label for="">Carbs</label>
                                <input class="form-control" type="text" name="carbs[]" id="" value="{{$carbs}}">
                            </div>

                            <div class="col-1">
                                <label for="">Fats</label>
                                <input class="form-control" type="text" name="fats[]" id="" value="{{$fats}}">
                            </div>
            
                            <div class="col-2">
                                <label for="">Calories</label>
                                <input class="form-control" type="text" name="calories[]" id="" value="{{$calories}}">
                            </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <a href="{{route('delete.diet',['id'=>$diet->id])}}"><button type="button" class="btn btn-primary  d-flex justify-content-end">Delete</button></a>
                            </div>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Add diet for </h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var mealCounter ={{$i}}; // Initialize the meal counter
